  ...
  return (
    <Navbar className="sticky top-0 z-10 h-max max-w-full bg-blue-200 rounded-none  md:px-4 py-2 lg:px-12 lg:py-4">
      <div className="flex items-center justify-between text-blue-gray-900">
        <NavLink
          to="/"
          className="mr-4 cursor-pointer py-1.5 font-bold animate-bounce text-pink-500 md:text-2xl"
        >
            ...
            {!user?.email ? (
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="hidden font-bold bg-white hover:bg-black hover:text-white  lg:inline-block"
                >
                  <span>Log In</span>
                </Button>
              </div>

...
const UpdateModal = ({
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    updatePersonnel(formValues?._id, formValues);
    getPersonnels();
  ...
  return (
    <div className=" absolute bg-indigo-200 pt-5  top-0 left-[calc(50%-250px)]  ">
      <h1 className="md:text-3xl font-bold text-center text-red-600">UPDATE</h1>
      <form
